...
public class AiChase extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_aichase);
        ...
        int totalScore=sharedPref.getInt("player_bat_first_key", 0);
    ...
    private void winFunction() {
        ...
        // player looses //
        Intent won = new Intent(AiChase.this, MatchLost.class);
    ...
    private void outFunction() {
        ...
        // ai looses //
        Intent end = new Intent(AiChase.this, MatchWon.class);

...
public class MatchLost extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_matchlost);
        CheckWinNumber();
        ...
        docRef.get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                if (document.exists()) {
                    ...
                    int a = Integer.parseInt(matchesPlayed) + 1;
                    matchPlayed = Integer.toString(a);
                    updateValues();

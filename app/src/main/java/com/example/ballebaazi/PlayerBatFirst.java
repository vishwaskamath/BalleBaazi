...
public class PlayerBatFirst extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_playerbatfirst);
    ...
    private void outFunction() {
        ...
        Intent end = new Intent(PlayerBatFirst.this, AiTarget.class);
        ...
        if (wickets < 9) {
            ...
            editor.putInt("player_bat_first_key", total);
